...
# Media player commands for desktop Ubuntu (Wayland via X11)
PLAYER_COMMANDS = {
    'vlc': ['cvlc', '--fullscreen', '--no-osd', '--loop', '--no-video-title-show', '--vout=xcb', '--file-logging', '--logfile=/home/obtv/signage/media/vlc.log', '--log-verbose=2']
}
